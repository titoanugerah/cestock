                    ...
                    <div class="row">
                      ...
                      <div class="col-7 col-md-8">
                        <div class="tab-content" id="v-pills-tabContent">
                          <div class="tab-pane fade" id="v-pills-home1" role="tabpanel" aria-labelledby="v-pills-home-tab" <?php if($account->status==0){ echo 'hidden';} ?>>
                          ...
                          <div class="tab-pane fade" id="v-pills-home0" role="tabpanel" aria-labelledby="v-pills-home-tab" <?php if($account->status==1){ echo 'hidden';} ?>>
                          ...
                          <div class="tab-pane fade active show" id="v-pills-message" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            fwfw
                          </div>
